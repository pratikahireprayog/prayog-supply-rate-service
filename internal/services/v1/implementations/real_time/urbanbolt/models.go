...
// UrbanboltRateRequest represents the request format for Urbanbolt Rate API (same as Smile)
type UrbanboltRateRequest struct {
...
// UrbanboltRateResponse represents the response format from Urbanbolt Rate API
type UrbanboltRateResponse struct {
	Status  string                   `json:"status"`
	Message string                   `json:"message,omitempty"`
	Data    *UrbanboltRateResponseData `json:"data,omitempty"`
	Error   *UrbanboltAPIError       `json:"error,omitempty"`
}

// Success returns true if the response status is "success"
func (r *UrbanboltRateResponse) Success() bool {
	return r.Status == "success"
}

// UrbanboltRateResponseData represents the data section of response (flat structure)
type UrbanboltRateResponseData struct {
...
// UrbanboltAPIError represents error information from API
type UrbanboltAPIError struct {
