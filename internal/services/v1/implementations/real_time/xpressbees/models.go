...
// XpressbeesRateRequest represents the request format for Xpressbees Rate API (same as Smile)
type XpressbeesRateRequest struct {
...
// XpressbeesRateResponse represents the response format from Xpressbees Rate API
type XpressbeesRateResponse struct {
	Status  string                      `json:"status"`
	Message string                      `json:"message,omitempty"`
	Data    *XpressbeesRateResponseData `json:"data,omitempty"`
	Error   *XpressbeesAPIError         `json:"error,omitempty"`
}

// Success returns true if the response status is "success"
func (r *XpressbeesRateResponse) Success() bool {
	return r.Status == "success"
}

// XpressbeesRateResponseData represents the data section of response (flat structure)
type XpressbeesRateResponseData struct {
...
// XpressbeesAPIError represents error information from API
type XpressbeesAPIError struct {
